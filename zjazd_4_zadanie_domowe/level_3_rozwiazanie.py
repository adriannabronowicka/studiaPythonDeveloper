...
class DigitStrMap:
    ...
    def _get_sequence_subdict(self, sequence: str) -> dict:
        ...
        for matched_char in sequence[1:]:  #dodano dwukropek za cyfrą 1, żeby pętla szła całej liście od 2 elementu
...
def main():
    with open(Path(__file__).parent.parent / "zjazd_4_2023 12 09" / "advent_1.txt") as file:
